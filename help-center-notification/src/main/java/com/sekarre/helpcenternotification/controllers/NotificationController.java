...
public class NotificationController {
    ...
    public ResponseEntity<?> markNotificationAsRead(@PathVariable String destinationId, @RequestParam String eventType) {
    ...
    public ResponseEntity<Integer> getNotificationCount(@PathVariable String destinationId, @RequestParam String eventType) {
